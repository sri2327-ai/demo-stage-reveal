...
export const MobileStageAnimation: React.FC<MobileAnimationProps> = ({
  ...
  const getColorTheme = () => {
    switch (currentStage) {
      case 0:
        return clinicalColorThemes.patientEngagement;
      case 1:
        return clinicalColorThemes.aiMedicalScribe;
      case 2:
        return clinicalColorThemes.adminTasks;
      case 3:
        return clinicalColorThemes.postVisitSupport;
      default:
        return clinicalColorThemes.aiMedicalScribe;
    }
  };
  ...
  const getStageTitle = () => {
    switch (currentStage) {
      ...
      case 1:
        return "AI Medical Scribe";
      case 2:
        return "Admin Tasks";
      case 3:
        return "Post-Visit Support";
      default:
        return "Clinical Workflow";
    }
  };
  ...
  const renderPatientEngagementInterface = (step: number) => {
    switch (step) {
      case 0:
        // Patient Messaging
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-3 mb-3 max-h-[140px] overflow-y-auto">
              ...
              <motion.div className="bg-gray-100 p-2 rounded-lg rounded-tl-none max-w-[80%]" initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="bg-blue-50 p-2 rounded-lg rounded-tr-none max-w-[80%] ml-auto" initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
            ...
            <div className="flex items-center border-t pt-2">
              ...
              <motion.button className="ml-2 w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center" whileTap={{
              scale: 0.9
            }}>
      ...
      case 1:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="grid grid-cols-7 gap-1 mb-3">
              ...
              {Array.from({
              length: 28
            }, (_, i) => <motion.div key={i} className={`text-center text-[10px] p-1 rounded-full ${i === 14 ? 'bg-blue-500 text-white' : ''}`} whileHover={{
              scale: 1.1
            }} whileTap={{
              scale: 0.9
            }}>
            ...
            <div className="mb-3">
              ...
              <div className="flex flex-wrap gap-1">
                <motion.div className="text-xs bg-blue-100 text-blue-700 px-2 py-1 rounded" whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
                ...
                <motion.div className="text-xs bg-blue-500 text-white px-2 py-1 rounded" whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
            ...
            <div className="mt-2">
              <motion.button className="w-full bg-blue-500 text-white text-xs py-2 rounded-md" whileTap={{
              scale: 0.98
            }} animate={{
      ...
      case 2:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 mb-3">
              ...
              <div>
                ...
                <div className="relative">
                  <motion.div className="absolute -top-2 -right-2 w-4 h-4 bg-blue-500 rounded-full flex items-center justify-center" initial={{
                  scale: 0
                }} animate={{
                  scale: 1
                }} transition={{
            ...
            <motion.div className="w-full bg-blue-500 text-white text-xs py-2 rounded-md text-center" whileTap={{
            scale: 0.98
          }}>
              Submit Form
            </motion.div>
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <motion.span className="text-blue-600 font-medium" animate={{
                opacity: [0.5, 1, 0.5]
              }} transition={{
                duration: 2,
                repeat: Infinity
            ...
            <div className="flex gap-2 mt-3">
              <motion.button className="flex-1 border border-blue-500 text-blue-500 text-xs py-1.5 rounded" whileTap={{
              scale: 0.98
            }}>
                Reschedule
              </motion.button>
              <motion.button className="flex-1 bg-blue-500 text-white text-xs py-1.5 rounded" whileTap={{
              scale: 0.98
            }}>
                Confirm
              </motion.button>
      ...
      case 4:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            <div className="border-b pb-2 mb-3 flex items-center justify-between">
              ...
              <motion.div className="w-10 h-10 rounded-full bg-green-500 flex items-center justify-center" animate={{
              scale: [1, 1.1, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            ...
            <div className="space-y-3 mb-4">
              <div className="bg-blue-50 p-2 rounded-lg">
                ...
                <div className="flex justify-end">
                  <motion.div className="w-4 h-4 mt-1" initial={{
                  opacity: 0
                }} animate={{
                  opacity: 1
                }} transition={{
              ...
              <motion.div className="bg-gray-100 p-2 rounded-lg" initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="bg-blue-50 p-2 rounded-lg" initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
            ...
            <div className="border-t pt-2 flex justify-between">
              <motion.button className="text-xs border border-red-500 text-red-500 rounded-full px-3 py-1.5" whileTap={{
              scale: 0.95
            }}>
                End Call
              </motion.button>
              
              <motion.div className="text-xs text-gray-500 flex items-center" animate={{
              opacity: [0.6, 1, 0.6]
            }} transition={{
              duration: 2,
              repeat: Infinity
    ...
    switch (step) {
      case 0:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-3 mb-4">
              <motion.div className="space-y-1" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
            ...
            <div className="space-y-2">
              <motion.button className="w-full bg-indigo-600 text-white text-xs py-2 rounded" whileTap={{
              scale: 0.98
            }} animate={{
              ...
              <motion.div className="flex items-center justify-center space-x-2 mt-2" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
      ...
      case 1:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 max-h-[180px] overflow-y-auto">
              <motion.div className="bg-blue-50 border-l-4 border-blue-500 p-2 rounded" initial={{
              opacity: 0,
              x: -10
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="border-l-4 border-green-500 bg-green-50 p-2 rounded" initial={{
              opacity: 0,
              x: -10
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="border-l-4 border-purple-500 bg-purple-50 p-2 rounded" initial={{
              opacity: 0,
              x: -10
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="border-l-4 border-amber-500 bg-amber-50 p-2 rounded" initial={{
              opacity: 0,
              x: -10
            }} animate={{
              opacity: 1,
            ...
            <div className="mt-3 pt-2 border-t">
              <div className="flex items-center justify-between mb-2">
                ...
                <motion.span className="text-xs text-green-600 font-medium" animate={{
                opacity: [0.5, 1, 0.5]
              }} transition={{
                duration: 2,
                repeat: Infinity
              ...
              <div className="flex items-center">
                <motion.div className="h-1.5 bg-blue-500 rounded-l" style={{
                width: "70%"
              }} animate={{
                width: ["70%", "100%", "70%"]
              }} transition={{
                ...
                <motion.div className="h-1.5 bg-gray-200 rounded-r" style={{
                width: "30%"
              }} animate={{
                width: ["30%", "0%", "30%"]
              }} transition={{
      ...
      case 2:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 max-h-[180px] overflow-y-auto mb-3">
              <motion.div className="bg-white border border-gray-200 rounded p-2" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="bg-green-50 border border-green-200 rounded p-2" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
      ...
      case 3:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            <div className="border-b pb-2 mb-3 flex items-center justify-between">
              ...
              <motion.div className="w-8 h-8 rounded-full bg-red-500 flex items-center justify-center" animate={{
              opacity: [0.7, 1, 0.7]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            ...
            <div className="space-y-3 mb-3 max-h-[180px] overflow-y-auto">
              ...
              <motion.div className="text-xs" initial={{
              opacity: 0
            }} animate={{
              opacity: 1
            }} transition={{
              delay: 0.5
                ...
                <span className="font-semibold text-blue-700">Dr. Smith:</span> 
                <motion.span className="text-gray-800" initial={{
                opacity: 0
              }} animate={{
                opacity: 1
              }} transition={{
            ...
            <div className="border-t pt-2">
              <div className="flex items-center justify-between mb-2">
                <div className="flex items-center text-xs text-gray-600">
                  <motion.div className="w-2 h-2 rounded-full bg-red-500 mr-1" animate={{
                  opacity: [0.5, 1, 0.5]
                }} transition={{
                  duration: 1,
                  repeat: Infinity
              ...
              <div className="flex gap-2">
                <motion.button className="flex-1 text-xs border border-gray-300 py-1.5 rounded" whileTap={{
                scale: 0.95
              }}>
                  Pause
                </motion.button>
                <motion.button className="flex-1 text-xs bg-blue-600 text-white py-1.5 rounded" whileTap={{
                scale: 0.95
              }}>
                  Generate Note
                </motion.button>
      ...
      case 4:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2 mt-3">
                <motion.button className="flex-1 text-xs border border-gray-300 py-1.5 rounded flex items-center justify-center" whileTap={{
                scale: 0.95
              }}>
                ...
                <motion.button className="flex-1 text-xs bg-blue-600 text-white py-1.5 rounded flex items-center justify-center" whileTap={{
                scale: 0.95
              }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1">
      ...
      case 5:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <motion.div className="border-t pt-3" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            delay: 1
              ...
              <motion.div className="flex items-center mt-3 text-xs text-green-600" animate={{
              opacity: [0.7, 1, 0.7]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
    ...
    switch (step) {
      case 0:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 mb-3">
              <div className="bg-yellow-50 border border-yellow-200 p-2 rounded-md">
                ...
                <div className="mt-1">
                  <div className="w-full h-1.5 bg-gray-200 rounded-full">
                    <motion.div className="h-1.5 bg-amber-500 rounded-full" initial={{
                    width: "0%"
                  }} animate={{
                    width: "60%"
                  }} transition={{
              ...
              <motion.div className="bg-green-50 border border-green-200 p-2 rounded-md" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="bg-red-50 border border-red-200 p-2 rounded-md" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
              ...
              delay: 0.5
                ...
                <div className="mt-1">
                  <div className="w-full h-1.5 bg-gray-200 rounded-full">
                    <motion.div className="h-1.5 bg-red-500 rounded-full w-1/3" animate={{
                    width: ["33%", "80%", "33%"]
                  }} transition={{
                    duration: 3,
                    repeat: Infinity
      ...
      case 1:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="border-t pt-2">
              <div className="flex gap-2">
                <motion.div className="flex-1 text-xs border border-gray-300 py-1.5 rounded-md flex items-center justify-center" whileTap={{
                scale: 0.95
              }}>
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1">
                    <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="mb-3">
              <div className="flex items-center justify-between mb-2">
                ...
                <motion.span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded-full" animate={{
            ...
            <motion.div className="space-y-2 mb-3" initial={{
            opacity: 0
          }} animate={{
            opacity: 1
          }} transition={{
            delay: 0.3
              ...
              <div className="w-full h-1.5 bg-gray-200 rounded-full">
                <motion.div className="h-1.5 bg-blue-600 rounded-full" initial={{
                width: "0%"
              }} animate={{
                width: "50%"
              }} transition={{
            ...
            <div className="border-t pt-2">
              ...
              <motion.button className="w-full text-xs bg-blue-600 text-white py-1.5 rounded-md flex items-center justify-center" whileTap={{
              scale: 0.98
            }}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1">
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 mb-3">
              ...
              <div className="space-y-2">
                ...
                <motion.div className="bg-blue-50 border border-blue-200 p-2 rounded-md" initial={{
                opacity: 0,
                y: 5
              }} animate={{
                opacity: 1,
                ...
                delay: 0.4
                  ...
                  <div className="flex justify-between">
                    ...
                    <motion.div className="text-blue-500" animate={{
                    scale: [1, 1.2, 1]
                  }} transition={{
                    duration: 2,
                    repeat: Infinity
                ...
                <motion.div className="bg-gray-50 border border-gray-200 p-2 rounded-md" initial={{
                opacity: 0,
                y: 5
              }} animate={{
                opacity: 1,
            ...
            <div className="border-t pt-2">
              <motion.div className="bg-blue-600 text-white text-center py-1.5 rounded-md text-xs mb-2" whileTap={{
              scale: 0.95
            }}>
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-3 mb-3">
              <div className="flex items-center space-x-3">
                <motion.div className="w-14 h-14 rounded-full border-4 border-blue-500 flex items-center justify-center" animate={{
                boxShadow: ["0px 0px 0px rgba(59, 130, 246, 0)", "0px 0px 8px rgba(59, 130, 246, 0.5)", "0px 0px 0px rgba(59, 130, 246, 0)"]
              }} transition={{
                duration: 2,
                repeat: Infinity
                ...
                <motion.div className="w-14 h-14 rounded-full border-4 border-green-500 flex items-center justify-center" animate={{
                ...
                <motion.div className="w-14 h-14 rounded-full border-4 border-purple-500 flex items-center justify-center" animate={{
              ...
              <div className="pt-2">
                ...
                <div className="h-12 flex items-end justify-between space-x-0.5">
                  {[150, 145, 142, 140, 139, 138, 138].map((value, i) => <motion.div key={i} className={`w-full rounded-t ${i === 6 ? 'bg-green-500' : 'bg-blue-500'}`} style={{
                  height: `${(value - 80) / 100 * 100}%`
                }} initial={{
                  height: 0
                }} animate={{
                  height: `${(value - 80) / 100 * 100}%`
      ...
      case 2:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-2 mb-3 max-h-[180px] overflow-y-auto">
              ...
              <motion.div className="bg-blue-50 p-2 rounded-lg rounded-tr-none max-w-[85%] ml-auto" initial={{
              opacity: 0,
              y: 10
            }} animate={{
              opacity: 1,
            ...
            <div className="flex items-center border-t pt-2">
              ...
              <motion.button className="ml-2 w-7 h-7 bg-blue-500 rounded-full flex items-center justify-center" whileTap={{
              scale: 0.9
            }}>
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <line x1="22" y1="2" x2="11" y2="13"></line>
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="mb-3">
              ...
              <div className="w-full h-2 bg-gray-200 rounded-full">
                <motion.div className="h-2 bg-green-500 rounded-full" style={{
                width: "57%"
              }} initial={{
                width: "0%"
              }} animate={{
            ...
            <div className="space-y-3 mb-3">
              <motion.div className="bg-green-50 border border-green-200 rounded-md p-2" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
              ...
              <motion.div className="bg-amber-50 border border-amber-200 rounded-md p-2" initial={{
              opacity: 0,
              y: 5
            }} animate={{
              opacity: 1,
            ...
            <div className="border-t pt-2">
              ...
              <motion.button className="w-full text-xs bg-blue-600 text-white py-1.5 rounded flex items-center justify-center" whileTap={{
              scale: 0.95
            }}>
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="mr-1">
                  <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path>
      ...
      case 4:
        ...
        return <div className="bg-white rounded-lg shadow-md p-3 max-w-[280px] mx-auto">
            ...
            <div className="space-y-4 mb-3">
              <div className="space-y-1">
                ...
                <div className="flex space-x-1">
                  {[1, 2, 3, 4, 5].map(star => <motion.svg key={star} width="16" height="16" viewBox="0 0 24 24" fill={star <= 5 ? "#FBBF24" : "none"} stroke={star <= 5 ? "#FBBF24" : "#9CA3AF"} strokeWidth="2" initial={{
                  scale: 0
                }} animate={{
                  scale: 1
                }} transition={{
            ...
            <div className="border-t pt-2">
              ...
              <motion.button className="w-full text-xs bg-blue-600 text-white py-1.5 rounded" whileTap={{
              scale: 0.95
            }}>
                Submit Feedback
              </motion.button>
  ...
  const getAnimationIcon = () => {
    switch (currentStage) {
      case 0:
        ...
        switch (subStep) {
          case 0:
            return <motion.div className="text-blue-500" animate={{
              scale: [1, 1.2, 1],
              opacity: [0.7, 1, 0.7]
            }} transition={{
              duration: 2,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15 14c.2-1 .7-1.7 1.5-2.5 1-.9 1.5-2.2 1.5-3.5A6 6 0 0 0 6 8c0 1 .2 2.2 1.5 3.5.7.7 1.3 1.5 1.5 2.5" /><path d="M9 18h6" /><path d="M10 22h4" /></svg></motion.div>;
          case 1:
            return <motion.div className="text-green-500" animate={{
              rotate: [0, 10, -10, 0]
            }} transition={{
              duration: 3,
              repeat: Infinity
          ...
          case 2:
            return <motion.div className="text-purple-500" animate={{
              y: [0, -5, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><path d="M14 2v6h6" /><path d="M16 13H8" /><path d="M16 17H8" /><path d="M10 9H8" /></svg></motion.div>;
          case 3:
            return <motion.div className="text-orange-500" animate={{
              scale: [1, 1.1, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9" /><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0" /></svg></motion.div>;
          case 4:
            return <motion.div className="text-cyan-500" animate={{
              rotateY: [0, 180, 360]
            }} transition={{
              duration: 3,
              repeat: Infinity
      ...
      case 1:
        ...
        switch (subStep) {
          case 0:
            return <motion.div className="text-indigo-500" animate={{
              scale: [1, 1.2, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="11" x="3" y="11" rx="2" ry="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg></motion.div>;
          case 1:
            return <motion.div className="text-blue-600" animate={{
              rotate: [0, 5, -5, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 3v4a1 1 0 0 0 1 1h4" /><path d="M17 21H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h7l5 5v11a2 2 0 0 1-2 2z" /><path d="M12 17v-6" /><path d="M9 14h6" /></svg></motion.div>;
          case 2:
            return <motion.div className="text-green-600" animate={{
              y: [0, -3, 0]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M15.5 9.5 12 6.5l-3.5 3" /><rect width="18" height="18" x="3" y="3" rx="2" /><path d="M12 6.5v8" /></svg></motion.div>;
          case 3:
            return <motion.div className="text-teal-500" animate={{
              scale: [1, 0.9, 1]
            }} transition={{
              duration: 2,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><polygon points="10 8 16 12 10 16 10 8" /></svg></motion.div>;
          case 4:
            return <motion.div className="text-purple-600" animate={{
              rotate: [0, 10, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 19.5v-15A2.5 2.5 0 0 1 6.5 2H20v20H6.5a2.5 2.5 0 0 1-2.5-2.5Z" /><path d="M10 2v20" /><path d="m17 12-5-4v8l5-4Z" /></svg></motion.div>;
          case 5:
            return <motion.div className="text-rose-500" animate={{
              scale: [1, 1.1, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3a6 6 0 0 0 9 9 9 9 0 1 1-9-9Z" /><path d="M12 12 8.5 8.5" /><path d="M16 16 9 9" /></svg></motion.div>;
          default:
            return <Circle size={40} />;
        }
      case 2:
        ...
        switch (subStep) {
          case 0:
            return <motion.div className="text-red-500" animate={{
              scale: [1, 1.2, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="8" /><path d="m12 8 1 3.5h6" /><path d="m12 8-1 3.5H5" /><path d="m16 16-2-1.5" /><path d="m8 16 2-1.5" /></svg></motion.div>;
          case 1:
            return <motion.div className="text-amber-500" animate={{
              y: [0, -5, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity
          ...
          case 2:
            return <motion.div className="text-emerald-500" animate={{
              rotate: [0, 10, -10, 0]
            }} transition={{
              duration: 3,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 10h12" /><path d="M4 14h9" /><path d="M17 14h3" /><path d="M17 10h3" /><rect width="18" height="12" x="3" y="6" rx="2" /></svg></motion.div>;
          default:
            return <Circle size={40} />;
        }
      case 3:
        ...
        switch (subStep) {
          case 0:
            return <motion.div className="text-lime-500" animate={{
              scale: [1, 1.1, 1]
            }} transition={{
              duration: 1.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 7.9l4.2 4.2L19 2" /><path d="M17 17H5" /><path d="M17 12H5" /></svg></motion.div>;
          case 1:
            return <motion.div className="text-sky-500" animate={{
              y: [0, -4, 0]
            }} transition={{
              duration: 2,
              repeat: Infinity
          ...
          case 2:
            return <motion.div className="text-cyan-600" animate={{
              rotate: [0, 5, -5, 0]
            }} transition={{
              duration: 2.5,
              repeat: Infinity
            }}><svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 2H4c-1.1 0-2 .9-2 2v12c0 1.1.9 2 2 2h4v4l4-4h8c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z" /><circle cx="12" cy="11" r="1" /><circle cx="17" cy="11" r="1" /><circle cx="7" cy="11" r="1" /></svg></motion.div>;
          case 3:
            return <motion.div className="text-indigo-600" animate={{
              scale: [1, 0.9, 1]
            }} transition={{
              duration: 2,
              repeat: Infinity
          ...
          case 4:
            return <motion.div className="text-violet-500" animate={{
              rotate: [0, 15, 0]
            }} transition={{
              duration: 3,
              repeat: Infinity
  ...
  console.log("MobileStageAnimation rendering:", {
    currentStage,
    subStep,
    maxSteps,
    labels,
  ...
  return <div className="w-full h-full flex flex-col">
      {/* Stage Title */}
      <motion.div className={`w-full px-4 py-3 ${colorTheme.background} rounded-t-xl border-b ${colorTheme.border} shadow-sm`} initial={{
      opacity: 0
    }} animate={{
      opacity: 1
    }} transition={{
      ...
      <div className={`flex-1 w-full overflow-hidden ${colorTheme.accent} flex flex-col items-center justify-center p-4`}>
        ...
        <AnimatePresence mode="wait">
          <motion.div key={`${currentStage}-${subStep}`} initial={{
          opacity: 0,
          scale: 0.9
        }} animate={{
          opacity: 1,
          ...
          duration: 0.4
            ...
            <div className="mb-6 relative">
              <motion.div className={`w-16 h-16 rounded-full flex items-center justify-center ${colorTheme.highlight} shadow-md border ${colorTheme.border}`} whileTap={{
              scale: 0.95
            }} animate={{
              ...
              <div className="absolute -left-12 top-1/2 transform -translate-y-1/2">
                <motion.button className={`p-2 rounded-full bg-white shadow-md text-[#143151] border ${colorTheme.border}`} whileTap={{
                scale: 0.9
              }} onClick={() => onStepChange((subStep - 1 + maxSteps) % maxSteps)} aria-label="Previous step">
                  <ChevronUp size={20} />
                </motion.button>
              </div>
              <div className="absolute -right-12 top-1/2 transform -translate-y-1/2">
                <motion.button className={`p-2 rounded-full bg-white shadow-md text-[#143151] border ${colorTheme.border}`} whileTap={{
                scale: 0.9
              }} onClick={() => onStepChange((subStep + 1) % maxSteps)} aria-label="Next step">
                  <ChevronDown size={20} />
                </motion.button>
              </div>
            </div>
            ...
            <motion.h4 className="text-xl font-semibold text-[#143151] mb-3 text-center" initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            <motion.p className="text-sm text-center text-gray-700 max-w-xs px-2 mb-2" initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            <motion.div className="w-full mt-2 mb-4 flex justify-center" initial={{
            opacity: 0,
            y: 10
          }} animate={{
            opacity: 1,
            ...
            <div className="flex items-center justify-center gap-2 mt-auto">
              {Array.from({
              length: maxSteps
            }, (_, i) => <motion.button key={i} className={`w-2.5 h-2.5 rounded-full ${subStep === i ? colorTheme.background : 'bg-gray-300'}`} whileTap={{
              scale: 0.8
            }} onClick={() => onStepChange(i)} aria-label={`Go to step ${i + 1}`} animate={subStep === i ? {
              scale: [1, 1.2, 1]
            } : {}} transition={subStep === i ? {
              duration: 1.5,
              repeat: Infinity
            } : {}} />)}
            </div>
