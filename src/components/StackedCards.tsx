  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-10 sm:top-20 right-10 sm:right-32 w-20 sm:w-40 h-20 sm:h-40 bg-blue-100 rounded-full blur-xl sm:blur-3xl opacity-15 sm:opacity-30"></div>
        <div className="absolute bottom-20 sm:bottom-32 left-8 sm:left-20 w-24 sm:w-52 h-24 sm:h-52 bg-purple-100 rounded-full blur-xl sm:blur-3xl opacity-20 sm:opacity-40"></div>
        <div className="absolute top-1/2 left-1/4 sm:left-1/3 w-16 sm:w-36 h-16 sm:h-36 bg-cyan-100 rounded-full blur-xl sm:blur-3xl opacity-15 sm:opacity-35"></div>
      </div>
                    ...
                    <div className="grid lg:grid-cols-2 gap-4 sm:gap-8 lg:gap-12 items-center">
                      <div className={card.theme === 'practice' ? 'order-2 lg:order-1' : ''}>
                        <div className="flex items-start gap-2.5 sm:gap-4 mb-3 sm:mb-6">
                          <div className="bg-gradient-to-br from-[#143151] to-[#387E89] p-1.5 sm:p-3 lg:p-4 rounded-lg sm:rounded-xl lg:rounded-2xl shadow-lg group-hover:scale-105 transition-transform duration-300 flex-shrink-0 mt-0.5 sm:mt-0">
                            {card.icon}
                          </div>
                        ...
                        <Card className="bg-gradient-to-br from-blue-50/70 via-sky-50/50 to-cyan-50/30 backdrop-blur-sm border border-blue-200/20 rounded-lg sm:rounded-xl lg:rounded-2xl p-3 sm:p-6 lg:p-8 shadow-md hover:shadow-lg transition-all duration-300">
                          <div className="space-y-2.5 sm:space-y-4 lg:space-y-6">
                            {card.features.map((feature, featureIndex) => (
                              ...
                              >
                                <div className="bg-gradient-to-br from-[#387E89] to-[#143151] p-1 sm:p-2 rounded-md sm:rounded-lg lg:rounded-xl shadow-md group-hover/feature:scale-105 transition-transform duration-200 flex-shrink-0 mt-0.5">
