      ...
      {isInteractive ? (
        <MouseTrackerProvider>
          <div className="relative h-full flex flex-col items-center justify-center">
            ...
            {/* Improved label visibility for mobile */}
            <AnimatePresence mode="wait">
              ...
              >
                <motion.div 
                  className="bg-gradient-to-r from-[#143151]/95 to-[#387E89]/95 backdrop-blur-md text-white px-4 py-3 sm:px-6 sm:py-4 rounded-lg sm:rounded-xl shadow-xl mx-auto max-w-sm sm:max-w-md md:max-w-xl lg:max-w-2xl border border-white/20"
        ...
        <div className="relative w-full h-full flex flex-col items-center justify-center">
          ...
          >
            <div className="bg-gradient-to-r from-[#143151]/95 to-[#387E89]/95 backdrop-blur-md text-white px-4 py-3 sm:px-6 sm:py-4 rounded-lg sm:rounded-xl shadow-xl mx-auto max-w-sm sm:max-w-md md:max-w-xl lg:max-w-2xl border border-white/20">
              <div className="font-bold text-base sm:text-lg md:text-xl lg:text-2xl">{getCurrentLabel().title}</div>
              <div className="mt-1 sm:mt-2 text-xs sm:text-sm md:text-base text-white/90">{getCurrentLabel().description}</div>
            </div>
          </motion.div>
