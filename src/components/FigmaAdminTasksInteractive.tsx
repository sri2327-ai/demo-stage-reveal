          ...
          <MouseTrackerProvider>
            <div className="relative h-full flex flex-col items-center justify-center pt-0">
              ...
              >
                ...
                {/* Only show Click to interact cursor */}
                {!isMobile && (
                  <Pointer>
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.div 
                    className="bg-gradient-to-r from-[#143151]/95 to-[#387E89]/95 backdrop-blur-md text-white px-3 py-2 sm:px-4 sm:py-3 md:px-6 md:py-4 rounded-xl shadow-xl mx-auto max-w-sm sm:max-w-md md:max-w-lg border border-white/20"
