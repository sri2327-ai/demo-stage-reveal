...
export default function SpecialtyBlogList(props: {
  ...
  return <>
      ...
      <div className="min-h-screen bg-gradient-subtle">
        <section className="py-16 sm:py-20 lg:py-28 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border-y border-white/20">
          <div className="container max-w-7xl">
            <div className="text-center lg:text-left max-w-4xl mx-auto lg:mx-0">
              <h1 className="text-3xl sm:text-4xl lg:text-6xl xl:text-7xl font-bold text-gradient mb-4 sm:mb-6 leading-tight">{specialty.name}</h1>
              <p className="text-base sm:text-lg lg:text-xl text-muted-foreground max-w-3xl mb-8 sm:mb-10 leading-relaxed">{specialty.description}</p>
              <Button size="lg" className="premium-button rounded-full px-8 py-4 text-base sm:text-lg font-semibold hover:scale-105 transition-all duration-300 mb-8 sm:mb-10 shadow-lg">
                Book a Demo
              </Button>
              <div className="flex flex-wrap gap-2 sm:gap-3 justify-center lg:justify-start">
                {specialty.tags.map(t => <Badge key={t} variant="outline" className="rounded-full px-3 py-1 text-sm">{t}</Badge>)}
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 sm:py-20 lg:py-32 bg-gradient-to-br from-purple-500/8 to-blue-500/8 relative overflow-hidden">
          {/* Background decoration */}
          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent"></div>
          <div className="container relative max-w-7xl">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16 lg:mb-20">
                <h2 className="text-2xl sm:text-3xl lg:text-5xl xl:text-6xl font-bold text-gradient mb-6 sm:mb-8 px-4 leading-tight">
              ...
              <div className="grid gap-8 sm:gap-10 lg:gap-12 mb-12 lg:mb-16 px-4">
                <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
                  <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-white/30 hover:border-primary/30 transition-all duration-500 group hover:shadow-elegant hover:-translate-y-2 h-full">
                    <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col">
                      <div className="w-16 h-16 lg:w-20 lg:h-20 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 flex-shrink-0 shadow-lg">
                      ...
                      <h3 className="font-bold text-xl lg:text-2xl mb-4 lg:mb-6 text-gradient">AI Pre-Charting for {specialty.name}</h3>
                      <p className="text-muted-foreground text-base lg:text-lg leading-relaxed flex-grow">Prepare for patient visits in minutes, not hours. S10.ai's AI Scribe + AI Agents deliver instant clinical priorities, updates, and patient insights—giving clinicians a complete, actionable view of every patient.</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-white/30 hover:border-primary/30 transition-all duration-500 group hover:shadow-elegant hover:-translate-y-2 h-full">
                    <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col">
                      ...
                      <h3 className="font-bold text-xl lg:text-2xl mb-4 lg:mb-6 text-gradient">Context-Aware Clinical Notes</h3>
                      <p className="text-muted-foreground text-base lg:text-lg leading-relaxed flex-grow">S10.ai automatically surfaces key details from past visits and customizes notes for today's encounter. Always accurate. Always relevant.</p>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid sm:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
                  <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-white/30 hover:border-primary/30 transition-all duration-500 group hover:shadow-elegant hover:-translate-y-2 h-full">
                    <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col">
                      ...
                      <h3 className="font-bold text-xl lg:text-2xl mb-4 lg:mb-6 text-gradient">Intelligent Coding & Billing</h3>
                      <p className="text-muted-foreground text-base lg:text-lg leading-relaxed flex-grow">Capture the full complexity of care without manual effort. AI-driven coding ensures accurate ICD-10, HCC, and E/M assignments, reducing errors and optimizing revenue.</p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-white/30 hover:border-primary/30 transition-all duration-500 group hover:shadow-elegant hover:-translate-y-2 h-full">
                    <CardContent className="p-6 sm:p-8 lg:p-10 h-full flex flex-col">
                      ...
                      <h3 className="font-bold text-xl lg:text-2xl mb-4 lg:mb-6 text-gradient">AI Phone & Chat Agents</h3>
                      <p className="text-muted-foreground text-base lg:text-lg leading-relaxed flex-grow">Manage patient calls, messages, confirmations, and follow-ups effortlessly. Fully integrated with your EHR, AI Chat and Phone Agents triage inquiries, provide instant answers, and log summaries automatically.</p>
                    </CardContent>
                  </Card>
                </div>

                {/* Custom Workflow Automation Card */}
                <Card className="bg-white backdrop-blur-sm border border-white/30 shadow-elegant hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group">
                  <CardContent className="p-8 sm:p-10 lg:p-12 text-center">
                    <div className="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-blue-500/30 to-purple-500/30 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-lg">
                    ...
                    <h3 className="font-bold text-2xl lg:text-3xl mb-6 text-gradient">Custom Workflow Automation</h3>
                    <p className="text-muted-foreground text-lg lg:text-xl leading-relaxed max-w-2xl mx-auto">Automate repetitive tasks like referrals, insurance verification, and lab notifications. HIPAA-compliant and tailored to {specialty.name.toLowerCase()} workflows for maximum impact.</p>
                  </CardContent>
                </Card>
              </div>

                {/* EMR Integration Highlight Card */}
                <Card className="bg-white backdrop-blur-sm border border-white/40 shadow-elegant hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden">
                  ...
                  <CardContent className="p-8 sm:p-10 lg:p-12 text-center relative z-10">
                    <div className="w-20 h-20 lg:w-24 lg:h-24 bg-gradient-to-br from-emerald-500/30 via-blue-500/30 to-purple-500/30 rounded-2xl flex items-center justify-center mx-auto mb-8 group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 shadow-lg">
                      <svg className="w-10 h-10 lg:w-12 lg:h-12 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13.828 10.172a4 4 0 00-5.656 0l-4 4a4 4 0 105.656 5.656l1.102-1.101m-.758-4.899a4 4 0 005.656 0l4-4a4 4 0 00-5.656-5.656l-1.1 1.1" />
                      </svg>
                    </div>
                    <h3 className="font-bold text-2xl lg:text-4xl mb-8 text-gradient">Seamless {specialty.name}-Specific EMR & App Integrations</h3>
                    <p className="text-muted-foreground text-lg lg:text-xl mb-10 leading-relaxed max-w-3xl mx-auto">Connects with your {specialty.name.toLowerCase()}-specific EMR and 7,000+ productivity apps. No screen-switching. No duplicate entries. Just smarter workflows.</p>
                    
                    <Button size="lg" className="premium-button rounded-full px-10 py-4 text-lg font-semibold hover:scale-105 transition-all duration-300 shadow-lg">
        ...
        {/* Results Section */}
        <section className="py-16 sm:py-20 lg:py-32 bg-gradient-to-bl from-blue-500/8 to-purple-500/8 relative overflow-hidden">
          {/* Background decoration */}
          ...
          <div className="container relative max-w-7xl">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-16 lg:mb-20 px-4">
                <h2 className="text-2xl sm:text-3xl lg:text-5xl xl:text-6xl font-bold text-gradient mb-6 sm:mb-8 leading-tight">
              ...
              <div className="grid gap-6 sm:gap-8 px-4">
                ...
                <Card className="bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-white/30 hover:border-primary/30 transition-all duration-500 group hover:shadow-elegant hover:-translate-y-2">
                  <CardContent className="p-8 lg:p-10 text-center">
                    <div className="text-4xl lg:text-5xl xl:text-6xl font-bold text-gradient mb-4 group-hover:scale-110 transition-transform duration-300">~80%</div>
                    <p className="text-muted-foreground text-base lg:text-lg font-medium">clinician adoption</p>
                  </CardContent>
                </Card>
        ...
        <section className="py-12 sm:py-16 lg:py-24 bg-gradient-to-tr from-purple-500/8 to-blue-500/8 relative overflow-hidden">
          ...
          <div className="container max-w-7xl">
            <div className="text-center mb-16 lg:mb-20">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gradient mb-6 leading-tight">{specialty.name} Insights & Resources</h2>
            </div>
