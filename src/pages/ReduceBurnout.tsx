  ...
  return (
    <>
      <Helmet>
        ...
        <meta 
          name="description" 
          content="Offload documentation and repetitive admin. The AI medical scribe handles notes and codes; AI phone/chat agents automate scheduling, intake, and follow-ups to restore balance."
        />
      </Helmet>
        ...
        <section className="py-16 lg:py-24">
          <div className="container">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {burnoutSolutions.map((solution, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
              ...
              >
                <div className="aspect-square bg-gradient-primary rounded-3xl p-8 glassmorphism">
                  <div className="w-full h-full bg-background/10 rounded-2xl flex items-center justify-center">
                    <Heart className="w-24 h-24 text-background/80" />
                  </div>
                </div>
              </motion.div>
            </div>
        ...
        <section className="py-16 lg:py-24 bg-muted/30">
          <div className="container">
            <FAQSection 
              ...
              subtitle="Everything you need to know about reducing clinician burnout with AI"
              faqs={faqs}
            />
          </div>
        </section>
