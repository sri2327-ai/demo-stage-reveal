...
const MedicalPrefixes = () => {
  ...
  const filteredPrefixes = searchQuery 
    ? searchPrefixes(searchQuery)
    : selectedLetter 
    ? getPrefixesByLetter(selectedLetter)
    : allPrefixes;
      ...
      <div className="container mx-auto px-4 py-8 sm:py-12 lg:py-16">
        ...
        <div className="text-center mb-8 sm:mb-12 lg:mb-16">
          ...
          <p className="text-lg sm:text-xl text-gray-600 mb-6 sm:mb-8 max-w-4xl mx-auto leading-relaxed">
            A comprehensive guide to medical prefixes used in healthcare terminology. 
            Understanding prefixes helps decode complex medical terms and improves clinical communication 
        ...
        <Card className="mb-8 sm:mb-12 bg-gradient-to-br from-white to-gray-50/50 border border-gray-200/60 shadow-lg">
          <CardHeader className="pb-4 sm:pb-6">
            <CardTitle className="flex items-center gap-2 sm:gap-3 text-xl sm:text-2xl font-bold text-[#143151]">
              ...
              Search & Filter Prefixes
            </CardTitle>
            <CardDescription className="text-sm sm:text-base text-gray-600">
              Find medical prefixes by term, meaning, or example words
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-6 sm:space-y-8">
            ...
            <div className="relative">
              ...
              <Input
                placeholder="Search prefixes (e.g., hyper-, above, cardiology...)"
                value={searchQuery}
                onChange={(e) => {
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg px-3 py-2 sm:px-4 sm:py-3">
              <div className="text-sm sm:text-base text-blue-800 font-medium">
                Showing <span className="font-bold">{filteredPrefixes.length}</span> of <span className="font-bold">{allPrefixes.length}</span> prefixes
        ...
        {filteredPrefixes.length === 0 && (
          <Card className="text-center py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-white to-gray-50/50 border border-gray-200/60">
            <CardContent>
              ...
              <h3 className="text-lg sm:text-xl font-semibold mb-2 sm:mb-3 text-[#143151]">No prefixes found</h3>
          ...
          <CardContent className="p-6 sm:p-8 lg:p-12">
            <div className="max-w-4xl mx-auto">
              <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-[#143151] mb-4 sm:mb-6 text-center">
                Understanding Medical Prefixes in Healthcare
              </h2>
              <div className="space-y-4 sm:space-y-6 text-gray-600 text-sm sm:text-base leading-relaxed">
                <p>
                  Medical prefixes are essential word parts that appear at the beginning of medical terms to modify 
                  their meaning. Understanding these prefixes helps healthcare professionals and students decode 
                  complex medical terminology efficiently and accurately communicate patient conditions.
                </p>
                <p>
                  Our comprehensive prefix guide includes etymology, clinical context, and real-world examples 
                  to help you master medical terminology. Each prefix entry provides multiple example words 
                ...
                <p>
                  ...
                  to understand medical documentation better, mastering these prefixes is fundamental to 
